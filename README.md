...
1. Automate the Orthanc -> listener forwarding (Orthanc Lua script
   ...
   manual "Send to modality" click. (DONE)
2. Validate the real model checkpoints end-to-end (this was built and
   ...
   available in the environment this was written in). (DONE)
3. Handle multi-frame/3D source images, not just single 2D frames. (TESTING)
